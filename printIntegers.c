 ...
 @printx prints the values for hexadecimal numbers using putchar
 
 printx:
 
        @ r0 = integer to output
        push {r4, r14}  @push registers to stack to remeber them for after the program execution
        ...
        loop:
                ...
                bgt loop
                        ...
                        @ Prints '0x' before printing the rest of the hexadecimal
 
        add r0, r9, $48         @ set r0 to '0'
        bl putchar              @ print '0'
        add r0, r9, $120        @ set 'x'
        bl putchar              @ print 'x'
        ...
        next:
                 ...
                 cmp r6, $9      @ If value is greater than 9, branch
                 bgt big
 ...
 @printd prints the values for decimal numbers using putchar
 ...
 printd:
        ...
        @This part does a lot of fancy bit shifts. At the end of these lines, r2 contains the quotient and r4 contains the     
        @remainder to be printed
